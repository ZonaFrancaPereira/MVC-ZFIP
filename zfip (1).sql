...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 20-01-2025 a las 23:12:24
...
(96, 'PRUEBA', 'AI', '', 'AM', '2024-11-20 15:56:33', 'PRUEBA', 'PRUEBA', 'No', '', '', '0000-00-00', 'Abierta Vencida', 'No', '', NULL, NULL, NULL, NULL, NULL, '2024-11-20', 1112),
(97, 'sadasd', 'AI', '', 'AM', '2025-01-20 13:39:01', 'asdasd', 'asdasd', 'No', '', '', '0000-00-00', 'Verificacion', 'Si', 'asdasd', NULL, NULL, NULL, NULL, NULL, '2025-01-20', 1112);
...
(182328, 'No Aplica', '2024-07-12 19:19:11', 'PC', 'LENOVO', 'LENOVO', 'AS8745', 'LENOVO', 'COMUNCACIONES', 'PISO 2', 'JJJ', 0, '2024-07-05', 951025, 'SSS', 1087561072, 'SS', 2, 'Activo', 'Si'),
...
(63, 'controladores/inspeccion.controlador.php'),
(64, 'modelos/inspeccion.modelo.php');
...
(1087561072, '5454', '545@gmail.com', '5454', '545', 'zfip');
...
(3, 1087561072, 'ingreso', 1, '', '453', '345', '435', '345', '345', 'regular', '345', 'Melissa', '105454', 'vistas/img/usuarios/firmas_inspeccion/678ec0d770caf.png', '2025-01-20 21:32:07', 1112);
...
(20, '2024-11-21', 1, 'NOC', '159', '1', 'ñ', 'SI', 'SI', 'SI', 'SI', 'SI', 'SI', 'SI', 'SI', 'SI', 'SI', 'SI', 'SI', 'SI', 'SI', 'SI', 'SI', 'SI', 'SI', 'SI', 'SI', 'SI', 'SI', 'vistas/img/usuarios/firmas/firma_yaque.png', 'Firmado'),
(21, '2024-11-26', 1112, 'NOC', '1', '1', '1', 'SI', 'SI', 'SI', 'SI', 'SI', 'SI', 'SI', 'SI', 'SI', 'SI', 'SI', 'SI', 'SI', 'SI', 'SI', 'SI', 'SI', 'SI', 'SI', 'SI', 'SI', 'SI', 'vistas/img/usuarios/firmas/firma_yaque.png', 'Firmado'),
(22, '2024-11-27', 1112, '4', '4', '4', '4', 'SI', 'SI', 'SI', 'SI', 'SI', 'SI', 'SI', 'SI', 'SI', 'SI', 'SI', 'SI', 'SI', 'SI', 'SI', 'SI', 'SI', 'SI', 'SI', 'SI', 'SI', 'SI', 'vistas/img/usuarios/firmas/firma_yaque.png', 'Firmado');
...
(2, 'Yuliana Melissa', 'Montoya', 'ymontoyag@zonafrancadepereira.com', '$2a$07$asxx54ahjppf45sd87a5auXBm1Vr2M1NV5t/zNQtGHGpS5fFirrbG', 5, '6580e9e49076c_meli.jpg', 1, 1, 2, NULL, '2024-09-04 17:08:01', NULL),
...
(1112, 'Administrador', 'admin', 'admin', '$2a$07$asxx54ahjppf45sd87a5auXBm1Vr2M1NV5t/zNQtGHGpS5fFirrbG', 1, 'vistas/img/usuarios/firmas/firma_yaque.png', 1, 1, 2, '2025-01-20 16:40:11', '2024-09-04 19:04:00', 16);
...
ALTER TABLE `inspeccion_op`
  ...
  ADD KEY `id_categoriaop_fk` (`id_categoriaop_fk`),
  ADD KEY `id_usuario_fk` (`id_usuario_fk`);
...
--
ALTER TABLE `acpm`
  MODIFY `id_consecutivo` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=98;
...
--
ALTER TABLE `activos`
  MODIFY `id_activo` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=182341;

--
-- AUTO_INCREMENT de la tabla `actualizacion_pw`
--
ALTER TABLE `actualizacion_pw`
  MODIFY `id_pw` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
...
--
ALTER TABLE `detalle_pw`
  MODIFY `id_detalle_pw` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT de la tabla `historial_transferencias`
--
ALTER TABLE `historial_transferencias`
  MODIFY `id_transferencia` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=88;
...
--
-- Filtros para la tabla `inspeccion_op`
--
ALTER TABLE `inspeccion_op`
  ADD CONSTRAINT `inspeccion_op_ibfk_1` FOREIGN KEY (`id_usuario_fk`) REFERENCES `usuarios` (`id`),
  ADD CONSTRAINT `inspeccion_op_ibfk_2` FOREIGN KEY (`id_cliente_fk`) REFERENCES `clientes_zfip` (`id_cliente`),
  ADD CONSTRAINT `inspeccion_op_ibfk_3` FOREIGN KEY (`id_categoriaop_fk`) REFERENCES `categoria_op` (`id_categoriaop`);
