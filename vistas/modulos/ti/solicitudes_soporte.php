...
<div class="card">
    <div class="card-header">
        <h3 class="card-title">Solicitudes de Soporte</h3>
    </div>
    <!-- /.card-header -->
    <div class="card-body">
        <table id="solicitud" class="table table-bordered table-striped">
            <thead>
                <tr>
                    <th>#</th>
                    <th>Usuario</th>
            ...
            <tbody>
                ...
                $item = null;
                $valor = null;
                $soportes = ControladorSoporte::ctrMostrarSoporteTi($item, $valor);
                foreach ($soportes as $key => $value) {
                    ...
                    echo '</td>
                                        ...
                                        <td>
                                            <button type="button" class="btn btn-outline-warning" data-toggle="modal" data-target="#modal-urgencia" data-id_soporte="' . $value["id_soporte"] . '">
                                                <i class="fas fa-hourglass-half"></i> Urgencia
                                            </button>
                                        </td>
                                        <td>
                                            <button type="button" class="btn btn-outline-info respuesta" data-toggle="modal" data-target="#modal-solicitud" data-id_soporte1="' . $value["id_soporte"] . '">
