            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header p-2">
                        ...
                        <li class="nav-item"><a class="nav-link active" href="#ConsultarPerfiles" data-toggle="tab">Consultar Perfiles</a></li>
                                    ...
                                    <table class="display table table-bordered table-striped dt-responsive " width="100%">
                                        ...
                                        <tbody>
                                            ...
                                            foreach ($usuarios as $key => $value) {
                                                ...
                                                echo ' <tr><td>' . $value["perfil"] . '</td> <td>' . $value["descripcion"] . '</td>';

                                                echo '<td> <button class="btn btn-warning btnEditarPerfil" idPerfil="' . $value["perfil"] . '" data-toggle="modal" data-target="#modalEditarPerfil"><i class="fas fa-edit"></i></button></td><td><button class="btn btn-danger btnEliminarPerfil" idPerfil="' . $value["perfil"] . '" ><i class="fas fa-times"></i></button></td></tr>';
                                            }
                                            ?>
                                        </tbody>
                                    ...
                                    <div class="tab-content" id="custom-tabs-one-tabContent">
                                        <div class="tab-pane fade show active" id="ti" role="tabpanel" aria-labelledby="custom-tabs-one-home-tab">
                                            ...
                                            <div class="pt-2 card">
                                                ...
                                                <div class="checkbox ">
                                                    <input type="checkbox" data-toggle="toggle" name="smCrearPerfiles" data-on="Si" data-off="No">
                                                ...
                                                <!-- Check FIRMAR Mantenimientos -->
                                                <div class="checkbox pt-2">
                                                    <input type="checkbox" data-toggle="toggle" name="smFirmarMantenimientos" data-on="Si" data-off="No">
                                                    <label for="exampleInputEmail1" data-toggle="tooltip" data-placement="top" title="Permisos para administrar los mantenimientos de equipos y dispositivos de ZFIP">Firmar Mantenimiento</label>
                                                </div>
                                                <p class="pt-2"><B>Gestionar Inventarios</B> : Permisos para crear, consultar, editar, eliminar Mantenimientos de los Recursos Tecnológicos</p>
                                                <!-- Check Inventario Licencias TI -->
                                                <div class="checkbox pt-2">
                                                    <input type="checkbox" data-toggle="toggle" name="smInventarioLicencias" data-on="Si" data-off="No">
                                                    <label for="exampleInputEmail1" data-toggle="tooltip" data-placement="top" title="Permisos para administrar el inventario de licencias">Inventario Licencias</label>
                                                </div>
                                        ...
                                        <div class="tab-pane fade" id="ct" role="tabpanel" aria-labelledby="custom-tabs-one-messages-tab">
                                            ...
                                            <div class="pt-2 card">
                                                ...
                                                <div class="checkbox">
                                                    ...
                                                    <label for="exampleInputEmail1" data-toggle="tooltip" data-placement="top" title="Permisos para crear Proveedores">Crear</label>
                                                </div>
                                                <!-- Check EDITAR PROVEEDOR -->
                                                <div class="checkbox">
                                                    <input type="checkbox" data-toggle="toggle" name="smAdminProveedorContabilidad" data-on="Si" data-off="No">
                                                    <label for="exampleInputEmail1" data-toggle="tooltip" data-placement="top" title="Permisos para responder actividades que tienen asignadas">Editar</label>
                                                </div>
